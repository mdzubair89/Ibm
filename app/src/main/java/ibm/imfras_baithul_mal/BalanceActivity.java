...
public class BalanceActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        columnHeader1.setText("ACCOUNT");
        columnHeader2.setText("ACTUAL");
        columnHeader3.setText("INTEREST");
        columnHeader4.setText("TOTAL");
    ...
    private void getResultsFromApi() {
        if (! isGooglePlayServicesAvailable()) {
            ...
            new BalanceActivity.MakeRequestTask(mCredential).execute();
        }
    }
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        private List<String> getDataFromApi() throws IOException {
            ...
            String query =  "BALANCE_TESTING!A5:D";
            String inf = null;
    ...
    private void setListadapter() {
        ListViewAdapter adapter= new ListViewAdapter(BalanceActivity.this,list,layout);
        listView.setAdapter(adapter);
