...
public class ViewReqGsheetActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_req_gsheet);
    ...
    private void getResultsFromApi() {
        if (!isGooglePlayServicesAvailable()) {
            ...
            new ViewReqGsheetActivity.MakeRequestTask(mCredential).execute();
        }
    }
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, Void> {
        ...
        private void populate(Object reqNo, Object purpose, Object ibmContrib, Object sepContrib) {

            String stReqNo = reqNo.toString();
            String stpurpose = purpose.toString();
            String stibmContrib = ibmContrib.toString();
            String stsepContrib = sepContrib.toString();

            HashMap<String, String> temp = new HashMap<String, String>();
            temp.put(FIRST_COLUMN, stReqNo);
            temp.put(SECOND_COLUMN, stpurpose);
            temp.put(THIRD_COLUMN, stibmContrib);
            temp.put(FOURTH_COLUMN, stsepContrib);
